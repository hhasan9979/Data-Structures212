// FILE: sequence1.h
// CLASS PROVIDED: sequence (part of the namespace data_structures_assignment_2)
//
...
#ifndef DATA_STRUCTURES_ASSIGNMENT_2_SEQUENCE_1_H
#define DATA_STRUCTURES_ASSIGNMENT_2_SEQUENCE_1_H
